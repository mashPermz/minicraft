...
- ✅ v1.1/v2 の実プレイ: オーナーがバージョンごとに都度プレイして確認する運用(問題があれば suggestion_box に走り書き → 次バージョンで対応)
...
- ⬜ v3の実プレイ: 都度プレイ運用で確認(注目点: 効果音の音量バランス・水流の見た目・モブを叩く/逃走・洞窟の暗さ。気になった点は suggestion_box へ)
